...
struct ObjectConstants
{
	...
	{
		 { { 0.8f, 0.8f, 0.8f }, 1.0f, { 0.57735f, -0.57735f, 0.57735f }, 10.0f, { }, 64.0f },
		 { { 1111.0f, 0.0f, 0.0f }, 1.0f, { -1.0f, 0.0f, 0.0f }, 15.0f, { 5, 8, 5 }, 64.0f },
		 { { 0.0f, 1111.0f, 0.0f }, 1.0f, { -1.0f, 0.0f, 0.0f }, 15.0f, { 5, 8, -5 }, 64.0f },
		 { { 0.0f, 0.0f, 1111.0f }, 1.0f, { -1.0f, 0.0f, 0.0f }, 15.0f, { -8, 8, 0 }, 64.0f },

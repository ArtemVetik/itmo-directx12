...
void Shader::BuildRootSignature()
{
	...
	cbvTable2.Init(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 1, 9);
	...
	slotRootParameter[4].InitAsDescriptorTable(1, &cbvTable2, D3D12_SHADER_VISIBILITY_ALL);

	auto a = GetStaticSamplers();

	// A root signature is an array of root parameters.
	CD3DX12_ROOT_SIGNATURE_DESC rootSigDesc(5, slotRootParameter, a.size(), a.data(),
